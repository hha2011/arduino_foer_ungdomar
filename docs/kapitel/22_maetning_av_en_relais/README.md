...
Vi behöver relän om vi vill skydda vär kära Arduino emot,
...
Vad bör du mäta om multimetern funkar?
Varför är det så?
...
Relä som är längst ner är relä nummer 1.
...
ingång en och två av det första relät, så här:
...
Det betyder att el kan strömma fritt mellan ingångar 1 och 2.

## 22.4. Mät mellan 2 och 3

Med din multimeter, mät motståndet mellan
ingång två och tre av den första relät, så här:
...
Det betyder att el kan inte strömma mellan ingångar 2 och 3.

## 22.5. Mät mellan 1 och 3

Med din multimeter, mäter motståndet mellan
ingång en och två på det första relät, så här:
...
Motstånded är oändligt Ohm.
Det betyder att el kan inte ströma mellan ingångar 1 och 3.
...
## 22.6. Sätt på en relä

Koppla `GND` av Arduino med `IN1` av reläkortet.
...
Mellan vilka stift är motståndet nu noll Ohm?

## Slutuppgift

Gå igenom all sex mätningar, som i tabellen här:
...
- förutspå vilket motstånd multimetern kommer visa
